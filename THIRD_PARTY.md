...
DUTler's own source is licensed under **Apache-2.0** (see [`LICENSE`](LICENSE)). It is built on, and links
...
- BSD-3-Clause and MIT are permissive, so combining them with DUTler's Apache-2.0 source and
